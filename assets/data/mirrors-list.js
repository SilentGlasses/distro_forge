...
//
// Entries are small on purpose \u2014 this file is a UI concern only; the
// generator falls back to the default CDN when no explicit mirror is
// picked. A scheduled workflow (see .github/workflows/update-mirrors.yml)
// may extend it with additional mirrors over time.

// Country names keyed by ISO 3166-1 alpha-2 code, for pretty <optgroup>
// labels.
...
export const debianMirrorList = [
  ...
  { country: "JP", name: "ftp.jp.debian.org",            url: "http://ftp.jp.debian.org/debian" },
...
// Ubuntu mirrors (primary arches \u2014 ports mirror handled separately by the generator).
...
export function groupByCountry(list) {
  ...
  // Sort country codes by pretty name.
